...
update_search_state new_buffer model = { model | search_buffer = new_buffer, search_state = make_search_state new_buffer model.search_state }

make_search_state : String -> Maybe SearchState -> Maybe SearchState
make_search_state query prev_state =
